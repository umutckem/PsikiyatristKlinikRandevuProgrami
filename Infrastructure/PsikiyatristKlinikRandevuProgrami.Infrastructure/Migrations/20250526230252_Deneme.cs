        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AliciKullaniciId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Tur = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Icerik = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GonderimYontemi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_bildirims", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaporIcerigi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OlusturmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_klinikRapors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HastaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PsikiyatristId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IlacBilgileri = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TedaviPlani = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    YazilmaTarihi = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_recetes", x => x.Id);
                });
